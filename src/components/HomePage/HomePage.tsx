    ...
    <div className="homepage">
      ...
      <form name="search__form" onSubmit={handleSubmit} className="search__form">
        <div className="search__container">
          <input type="text" value={valueFromSearchedInput || ''} onChange={handleChangeSearchedInput} id="word-input" className="search__input" name="search-input" placeholder="Word" />
